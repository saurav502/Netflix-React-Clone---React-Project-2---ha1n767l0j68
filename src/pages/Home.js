...
const Home = () => {
  const [featuredMovies, setFeaturedMovies] = useState([{
    ...
    "title": "Contagion",
    "description": "In the heart of the jungle, lies a secret that's waiting to be uncovered.",
    "keywords": [
        "romance",
        "mystery",
        "drama"
    ],
    "thumbnail": "https://newton-project-resume-backend.s3.ap-south-1.amazonaws.com/posters/tt8614884.jpg",
    "type": "video song",
    ...
    "video_url": "https://newton-project-resume-backend.s3.amazonaws.com/video/64cffee700bad552e8dcd509.mp4"
}]);
  ...
  const carouselSettings = {
    ...
    infinite: true,
    speed: 500,
    slidesToShow: 3, // Number of movies shown in each slide
    slidesToScroll: 1,
  };
